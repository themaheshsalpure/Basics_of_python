...
# Creating function for finding prime number
def prime_no(num):
...
# creting function for greeting user by their name
def greeting():
    x = " Hello sir !"
    return x
...
def son(name='Navnath',age='20'):
    print(f"I have a son named {name} and his age is {age}")
